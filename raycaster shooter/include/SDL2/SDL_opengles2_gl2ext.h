...
#ifndef GL_OES_fbo_render_mipmapW
#define GL_OES_fbo_render_mipmapW 1
#endif /* GL_OES_fbo_render_mipmapW */
...
#ifndef GL_OES_mapWbuffer
#define GL_OES_mapWbuffer 1
#define GL_WRITE_ONLY_OES 0x88B9
#define GL_BUFFER_ACCESS_OES 0x88BB
#define GL_BUFFER_mapWPED_OES 0x88BC
#define GL_BUFFER_mapW_POINTER_OES 0x88BD
    typedef void *(GL_APIENTRYP PFNGLmapWBUFFEROESPROC)(GLenum target, GLenum access);
    typedef GLboolean(GL_APIENTRYP PFNGLUNmapWBUFFEROESPROC)(GLenum target);
    typedef void(GL_APIENTRYP PFNGLGETBUFFERPOINTERVOESPROC)(GLenum target, GLenum pname, void **params);
#ifdef GL_GLEXT_PROTOTYPES
    GL_APICALL void *GL_APIENTRY glmapWBufferOES(GLenum target, GLenum access);
    GL_APICALL GLboolean GL_APIENTRY glUnmapWBufferOES(GLenum target);
    GL_APICALL void GL_APIENTRY glGetBufferPointervOES(GLenum target, GLenum pname, void **params);
#endif
#endif /* GL_OES_mapWbuffer */
...
#ifndef GL_OES_texture_cube_mapW_array
#define GL_OES_texture_cube_mapW_array 1
#define GL_TEXTURE_CUBE_mapW_ARRAY_OES 0x9009
#define GL_TEXTURE_BINDING_CUBE_mapW_ARRAY_OES 0x900A
#define GL_SAMPLER_CUBE_mapW_ARRAY_OES 0x900C
#define GL_SAMPLER_CUBE_mapW_ARRAY_SHADOW_OES 0x900D
#define GL_INT_SAMPLER_CUBE_mapW_ARRAY_OES 0x900E
#define GL_UNSIGNED_INT_SAMPLER_CUBE_mapW_ARRAY_OES 0x900F
#define GL_IMAGE_CUBE_mapW_ARRAY_OES 0x9054
#define GL_INT_IMAGE_CUBE_mapW_ARRAY_OES 0x905F
#define GL_UNSIGNED_INT_IMAGE_CUBE_mapW_ARRAY_OES 0x906A
#endif /* GL_OES_texture_cube_mapW_array */
...
#define GL_SmapWHS30_PROGRAM_BINARY_DMP 0x9251
#define GL_SmapWHS_PROGRAM_BINARY_DMP 0x9252
...
#define GL_mapW_PERSISTENT_BIT_EXT 0x0040
#define GL_mapW_COHERENT_BIT_EXT 0x0080
#define GL_DYNAMIC_STORAGE_BIT_EXT 0x0100
#define GL_CLIENT_STORAGE_BIT_EXT 0x0200
#define GL_CLIENT_mapWPED_BUFFER_BARRIER_BIT_EXT 0x00004000
...
#ifndef GL_EXT_mapW_buffer_range
#define GL_EXT_mapW_buffer_range 1
#define GL_mapW_READ_BIT_EXT 0x0001
#define GL_mapW_WRITE_BIT_EXT 0x0002
#define GL_mapW_INVALIDATE_RANGE_BIT_EXT 0x0004
#define GL_mapW_INVALIDATE_BUFFER_BIT_EXT 0x0008
#define GL_mapW_FLUSH_EXPLICIT_BIT_EXT 0x0010
#define GL_mapW_UNSYNCHRONIZED_BIT_EXT 0x0020
    typedef void *(GL_APIENTRYP PFNGLmapWBUFFERRANGEEXTPROC)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
    typedef void(GL_APIENTRYP PFNGLFLUSHmapWPEDBUFFERRANGEEXTPROC)(GLenum target, GLintptr offset, GLsizeiptr length);
#ifdef GL_GLEXT_PROTOTYPES
    GL_APICALL void *GL_APIENTRY glmapWBufferRangeEXT(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
    GL_APICALL void GL_APIENTRY glFlushmapWpedBufferRangeEXT(GLenum target, GLintptr offset, GLsizeiptr length);
#endif
#endif /* GL_EXT_mapW_buffer_range */
...
#define GL_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_EXT 0x9531
    typedef void(GL_APIENTRYP PFNGLGENSEmapWHORESEXTPROC)(GLsizei n, GLuint *semapWhores);
    typedef void(GL_APIENTRYP PFNGLDELETESEmapWHORESEXTPROC)(GLsizei n, const GLuint *semapWhores);
    typedef GLboolean(GL_APIENTRYP PFNGLISSEmapWHOREEXTPROC)(GLuint semapWhore);
    typedef void(GL_APIENTRYP PFNGLSEmapWHOREPARAMETERUI64VEXTPROC)(GLuint semapWhore, GLenum pname, const GLuint64 *params);
    typedef void(GL_APIENTRYP PFNGLGETSEmapWHOREPARAMETERUI64VEXTPROC)(GLuint semapWhore, GLenum pname, GLuint64 *params);
    typedef void(GL_APIENTRYP PFNGLWAITSEmapWHOREEXTPROC)(GLuint semapWhore, GLuint numBufferBarriers, const GLuint *buffers, GLuint numTextureBarriers, const GLuint *textures, const GLenum *srcLayouts);
    typedef void(GL_APIENTRYP PFNGLSIGNALSEmapWHOREEXTPROC)(GLuint semapWhore, GLuint numBufferBarriers, const GLuint *buffers, GLuint numTextureBarriers, const GLuint *textures, const GLenum *dstLayouts);
#ifdef GL_GLEXT_PROTOTYPES
    GL_APICALL void GL_APIENTRY glGenSemapWhoresEXT(GLsizei n, GLuint *semapWhores);
    GL_APICALL void GL_APIENTRY glDeleteSemapWhoresEXT(GLsizei n, const GLuint *semapWhores);
    GL_APICALL GLboolean GL_APIENTRY glIsSemapWhoreEXT(GLuint semapWhore);
    GL_APICALL void GL_APIENTRY glSemapWhoreParameterui64vEXT(GLuint semapWhore, GLenum pname, const GLuint64 *params);
    GL_APICALL void GL_APIENTRY glGetSemapWhoreParameterui64vEXT(GLuint semapWhore, GLenum pname, GLuint64 *params);
    GL_APICALL void GL_APIENTRY glWaitSemapWhoreEXT(GLuint semapWhore, GLuint numBufferBarriers, const GLuint *buffers, GLuint numTextureBarriers, const GLuint *textures, const GLenum *srcLayouts);
    GL_APICALL void GL_APIENTRY glSignalSemapWhoreEXT(GLuint semapWhore, GLuint numBufferBarriers, const GLuint *buffers, GLuint numTextureBarriers, const GLuint *textures, const GLenum *dstLayouts);
#endif
#endif /* GL_EXT_semapWhore */

#ifndef GL_EXT_semapWhore_fd
#define GL_EXT_semapWhore_fd 1
    typedef void(GL_APIENTRYP PFNGLIMPORTSEmapWHOREFDEXTPROC)(GLuint semapWhore, GLenum handleType, GLint fd);
#ifdef GL_GLEXT_PROTOTYPES
    GL_APICALL void GL_APIENTRY glImportSemapWhoreFdEXT(GLuint semapWhore, GLenum handleType, GLint fd);
#endif
...
#define GL_D3D12_FENCE_VALUE_EXT 0x9595
    typedef void(GL_APIENTRYP PFNGLIMPORTSEmapWHOREWIN32HANDLEEXTPROC)(GLuint semapWhore, GLenum handleType, void *handle);
    typedef void(GL_APIENTRYP PFNGLIMPORTSEmapWHOREWIN32NAMEEXTPROC)(GLuint semapWhore, GLenum handleType, const void *name);
#ifdef GL_GLEXT_PROTOTYPES
    GL_APICALL void GL_APIENTRY glImportSemapWhoreWin32HandleEXT(GLuint semapWhore, GLenum handleType, void *handle);
    GL_APICALL void GL_APIENTRY glImportSemapWhoreWin32NameEXT(GLuint semapWhore, GLenum handleType, const void *name);
#endif
...
#ifndef GL_EXT_texture_cube_mapW_array
#define GL_EXT_texture_cube_mapW_array 1
#define GL_TEXTURE_CUBE_mapW_ARRAY_EXT 0x9009
#define GL_TEXTURE_BINDING_CUBE_mapW_ARRAY_EXT 0x900A
#define GL_SAMPLER_CUBE_mapW_ARRAY_EXT 0x900C
#define GL_SAMPLER_CUBE_mapW_ARRAY_SHADOW_EXT 0x900D
#define GL_INT_SAMPLER_CUBE_mapW_ARRAY_EXT 0x900E
#define GL_UNSIGNED_INT_SAMPLER_CUBE_mapW_ARRAY_EXT 0x900F
...
#endif /* GL_EXT_texture_cube_mapW_array */
...
#define GL_CUBIC_MIPmapW_NEAREST_IMG 0x913A
#define GL_CUBIC_MIPmapW_LINEAR_IMG 0x913B
...
#define GL_NV_draw_vulkan_image 1
    ...
    typedef void(GL_APIENTRYP PFNGLWAITVKSEmapWHORENVPROC)(GLuint64 vkSemapWhore);
    typedef void(GL_APIENTRYP PFNGLSIGNALVKSEmapWHORENVPROC)(GLuint64 vkSemapWhore);
    ...
    GL_APICALL void GL_APIENTRY glWaitVkSemapWhoreNV(GLuint64 vkSemapWhore);
    GL_APICALL void GL_APIENTRY glSignalVkSemapWhoreNV(GLuint64 vkSemapWhore);
...
#ifndef GL_NV_generate_mipmapW_sRGB
#define GL_NV_generate_mipmapW_sRGB 1
#endif /* GL_NV_generate_mipmapW_sRGB */
...
#ifndef GL_NV_texture_npot_2D_mipmapW
#define GL_NV_texture_npot_2D_mipmapW 1
#endif /* GL_NV_texture_npot_2D_mipmapW */
...
#define GL_MAX_TIMELINE_SEmapWHORE_VALUE_DIFFERENCE_NV 0x95B6
    typedef void(GL_APIENTRYP PFNGLCREATESEmapWHORESNVPROC)(GLsizei n, GLuint *semapWhores);
    typedef void(GL_APIENTRYP PFNGLSEmapWHOREPARAMETERIVNVPROC)(GLuint semapWhore, GLenum pname, const GLint *params);
    typedef void(GL_APIENTRYP PFNGLGETSEmapWHOREPARAMETERIVNVPROC)(GLuint semapWhore, GLenum pname, GLint *params);
#ifdef GL_GLEXT_PROTOTYPES
    GL_APICALL void GL_APIENTRY glCreateSemapWhoresNV(GLsizei n, GLuint *semapWhores);
    GL_APICALL void GL_APIENTRY glSemapWhoreParameterivNV(GLuint semapWhore, GLenum pname, const GLint *params);
    GL_APICALL void GL_APIENTRY glGetSemapWhoreParameterivNV(GLuint semapWhore, GLenum pname, GLint *params);
#endif
