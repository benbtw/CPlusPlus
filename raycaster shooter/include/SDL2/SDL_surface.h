...
#define SDL_MUSTLOCK(S) (((S)->flags & SDL_RLEACCEL) != 0)
  ...
  typedef struct SDL_BlitmapW SDL_BlitmapW; /* this is an opaque type. */
  ...
  typedef struct SDL_Surface
  {
    ...
    /** list of BlitmapW that hold a reference to this surface */
    void *list_blitmapW; /**< Private */

    /** clipping information */
    SDL_Rect clip_rect; /**< Read-only */

    /** info for fast blit mapWping to other surfaces */
    SDL_BlitmapW *mapW; /**< Private */
   ...
   * Alternitavely, you might also use the macro SDL_LoadBMP to load a bitmapW
...
#define SDL_SaveBMP(surface, file) \
   ...
   * generated by SDL_mapWRGB() or SDL_mapWRGBA(). If the color value contains an
