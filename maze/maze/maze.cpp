...
'\xDB','\xDB','\xDB','\xDB','\xDB',' ','\xDB',' ','\xDB',' ','\xDB',' ','\xDB',' ','\xDB',' ','\xDB','\xDB','\xDB',' ','\xDB','\xDB','\xDB','\xDB','\xDB',
'\xDB',' ',' ',' ',' ',' ','\xDB',' ',' ',' ','\xDB',' ','\xDB',' ','\xDB',' ','\xDB',' ',' ',' ',' ',' ',' ','\xDB',
'\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','\xDB','F',
};
...
void Player() // handles the player input
{
	...
	{
	case 'w':
		if (map[posX - 1][posY] != '\xDB') { // collision check
